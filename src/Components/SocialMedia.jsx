...
const SocialMedia = () => {
  return (
    <div className="flex flex-wrap gap-5 items-center justify-center p-10">
      <Link to="https://www.facebook.com/dattyogfarmer" target="_blank">
        <button
          type="button"
      ...
      <Link to="https://www.instagram.com/dattyogfarmer/" target="_blank">
        <button
          type="button"
          data-twe-ripple-init
          data-twe-ripple-color="light"
          className="mb-2 inline-block rounded bg-[#E1306C] px-6 py-2.5 text-xs font-medium uppercase leading-normal text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg"
        >
          <span className="[&>svg]:h-4 [&>svg]:w-4">
            <svg
              xmlns="http://www.w3.org/2000/svg"
      ...
      <Link
        to="https://www.linkedin.com/company/dattayog-farmer/c"
        target="_blank"
      >
        <button
          type="button"
...
<button
  ...
  <span className="[&>svg]:h-4 [&>svg]:w-4">
    <svg
      ...
      <Link to="https://t.globallinker.com/jRLSc" target="_blank">
        <button
          type="button"
          data-twe-ripple-init
          data-twe-ripple-color="light"
          className="mb-2 inline-block rounded bg-[#0e3f4a] px-6 py-2.5 text-xs font-medium uppercase leading-normal text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg"
        >
          <span className="[&>svg]:h-4 [&>svg]:w-4">
            <img
